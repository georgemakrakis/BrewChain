...
const BrewChain = function ()
{
    ...
    function createBlock(data)
    {
        ...
        //This call may block the thread, disabling al other functionality like responding to HTTP and P2P requests
        newBlock = proofOfWork(newBlock);

        return newBlock;
    }

    //We can always know that the work has been done by this method
